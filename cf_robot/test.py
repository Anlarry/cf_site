...
html = s.get('http://codeforces.com/enter?back=%2F').text
bs = BeautifulSoup(html, "lxml")
csrf_token = bs.find(attrs={'name':'X-Csrf-Token'}).attrs['content']
...
form_data={
			...
			'ftaa' : '',
			'bfaa' : '',
			'handleOrEmail' : "__Wind__",
			'password' : "654183",
			'remember' : []
		}

rps = s.post(url='http://codeforces.com/enter', data=form_data) 
print(rps)
pass
